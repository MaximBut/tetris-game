...
pygame.init()
pygame.mixer.init()
pygame.display.set_caption("Тетрис, F1 помощь")
pygame.mixer.music.load("Music/TheFatRat-Arcadia.mp3")
...
game_bg = pygame.image.load('Background/bg2.jpg').convert()
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_LEFT:
                ...
                a = os.path.abspath('Instructions.txt')
                os.startfile(f'{a}')
